...
const app = new Vue(
    {
        ...
        methods: {
            ...
            // Mostra al click menu a tendina del messaggio
            showMenu(index) {
                this.activeMenu = index;
                
                // Mostro menu al click quando menuVisible = false (default)
                // Nascondo menu al click quando menuVisible = true
            ...
            deleteMessage(index) {
                ...
                // Nascondo menu al click su "Delete message" quando menuVisible = true
